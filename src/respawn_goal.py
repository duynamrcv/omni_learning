...
class Respawn():
    def __init__(self):
        ...
        self.modelPath = self.modelPath.replace('omni_learning/src',
                                                'omni_learning/gazebo/stage/model.sdf')
        ...
        self.modelName = 'goal'
        self.obstacle_1 = 5.0, 5.0
        self.obstacle_2 = 5.0, -5.0
        self.obstacle_3 = -5.0, 5.0
        self.obstacle_4 = -5.0, -5.0
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        while position_check:
            goal_x = random.randrange(-10, 10)
            goal_y = random.randrange(-10, 10)
